    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-white hover:text-white hover:bg-white/10"
        ),
        ...
        day_outside:
          "day-outside text-white/50 aria-selected:bg-accent/50 aria-selected:text-white/50 aria-selected:opacity-30",
        day_disabled: "text-white/50",
        day_range_middle:
